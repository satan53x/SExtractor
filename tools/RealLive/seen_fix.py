...
XorTable = {
	...
	#キミベタ ～キミをベタベタにさせてあげる～
	9: bytearray.fromhex('F1 77 BF 6E B7 6C 78 42 91 4C B7 65 30 0C AA A0'),
	...
	#Scramble Heart
	59: bytearray.fromhex('62 0E 26 6E 6F F0 A6 18 CB EB A9 74 2D E6 F3 1E'),
